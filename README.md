...
Follow the steps below to install and enable the Notifications app.
...
- [Notification Workflow (for app developers)](https://github.com/owncloud/notifications/blob/master/docs/notification-workflow.md)
- [OCS Endpoint v1 (for client developers)](https://github.com/owncloud/notifications/blob/master/docs/ocs-endpoint-v1.md)
...
**[Star](https://github.com/owncloud/notifications)** this repo and **Watch** for release notifications!
