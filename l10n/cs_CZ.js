OC.L10N.register(
    ...
    "Hello," : "Ahoj,",
    "See <a href=\"%s\">%s</a> on %s for more information" : "Přečti si <a href=\"%s\">%s</a> na %s pro více informací",
    "See %s on %s for more information" : "Přečti si %s na %s pro více informací",
