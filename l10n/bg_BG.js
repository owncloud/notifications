OC.L10N.register(
    ...
    "Unknown user session. It is not possible to set the option" : "Неизвестна потребителска сесия. Не е възможно да се зададе опцията",
    "Option not supported" : "Неподдържана опция",
    "Saved" : "Запазено",
    "Incomplete data" : "Непълни данни",
    "Do not notify via mail" : "Без уведомяване чрез имейл",
    "Notify only when an action is required" : "Уведомяване, само когато е необходимо действие",
